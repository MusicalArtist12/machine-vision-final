...
\begin{document}
    ...
    \begin{center}
        \begin{tabular}{| l | r |}
            ...
            \hline
            Learning Rate & How large can the optimizer make changes? \\
            \hline
            Number of Epochs & How long until it converges? \\
            \hline
        \end{tabular}
    \end{center}
    ...
    Finding the correct loss to train this model was the most complex part of this project by far, and the major trials will be explained in the results section later on.
